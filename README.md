...
Website oficial em página única (Single Page Application) com sistema integrado de agendamento online para **Rosa di Fiore** (Anne).
...
├── style.css      # Estilização visual, paleta Rosa di Fiore e responsividade
├── script.js      # Lógica de agendamento online, consulta à planilha e WhatsApp
├── robots.txt     # Diretrizes para robôs de busca
├── sitemap.xml    # Mapa XML para SEO
└── README.md      # Documentação do projeto
```

## 🚀 Como Executar

Basta abrir o arquivo `index.html` em qualquer navegador web ou hospedar em plataformas como GitHub Pages, Netlify ou Vercel.
